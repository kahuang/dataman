...
CREATE SEQUENCE "public"."dataman_field_type__id_seq"
 ...
 START 2
 CACHE 1;
SELECT setval('"public"."dataman_field_type__id_seq"', 2, true);
...
CREATE SEQUENCE "public"."datasource_field_type__id_seq"
 ...
 START 11
 CACHE 1;
SELECT setval('"public"."datasource_field_type__id_seq"', 11, true);
...
CREATE SEQUENCE "public"."field_type__id_seq"
 ...
 START 2
 CACHE 1;
SELECT setval('"public"."field_type__id_seq"', 2, true);
...
"_id" int4 DEFAULT nextval('constraint__id_seq'::regclass) NOT NULL,
...
-- ----------------------------
-- Records of constraint
-- ----------------------------
INSERT INTO "public"."constraint" VALUES ('1', '<', 'Less Than');
INSERT INTO "public"."constraint" VALUES ('2', '>', 'Greated Than');
INSERT INTO "public"."constraint" VALUES ('3', '<=', 'Less Than or Equal To');
INSERT INTO "public"."constraint" VALUES ('4', '>=', 'Greated Than or Equal To');
INSERT INTO "public"."constraint" VALUES ('5', '==', 'Equal To');
INSERT INTO "public"."constraint" VALUES ('6', '!=', 'Not Equal To');
INSERT INTO "public"."constraint" VALUES ('7', 'IN', 'In Set');
INSERT INTO "public"."constraint" VALUES ('8', 'NOT IN', 'Not In Set');

-- ----------------------------
-- Table structure for constraint_arg
-- ----------------------------
DROP TABLE IF EXISTS "public"."constraint_arg";
CREATE TABLE "public"."constraint_arg" (
"_id" int4 DEFAULT nextval('constraint_args__id_seq'::regclass) NOT NULL,
"name" varchar(255) COLLATE "default" NOT NULL,
"dataman_field_type_id" int4 NOT NULL,
...
-- ----------------------------
-- Records of constraint_arg
-- ----------------------------
INSERT INTO "public"."constraint_arg" VALUES ('1', 'value', '1', '1');

-- ----------------------------
-- Table structure for constraint_dataman_field_type
-- ----------------------------
DROP TABLE IF EXISTS "public"."constraint_dataman_field_type";
CREATE TABLE "public"."constraint_dataman_field_type" (
"_id" int4 DEFAULT nextval('constraint_dataman_field_type__id_seq'::regclass) NOT NULL,
"constraint_id" int4 NOT NULL,
"dataman_field_type_id" int4
)
WITH (OIDS=FALSE)
...
-- ----------------------------
-- Records of constraint_dataman_field_type
-- ----------------------------
INSERT INTO "public"."constraint_dataman_field_type" VALUES ('1', '1', '1');
INSERT INTO "public"."constraint_dataman_field_type" VALUES ('2', '1', '2');
INSERT INTO "public"."constraint_dataman_field_type" VALUES ('3', '2', '1');
INSERT INTO "public"."constraint_dataman_field_type" VALUES ('4', '2', '2');
INSERT INTO "public"."constraint_dataman_field_type" VALUES ('5', '3', '1');
INSERT INTO "public"."constraint_dataman_field_type" VALUES ('6', '3', '2');
INSERT INTO "public"."constraint_dataman_field_type" VALUES ('7', '4', '1');
INSERT INTO "public"."constraint_dataman_field_type" VALUES ('8', '4', '2');
INSERT INTO "public"."constraint_dataman_field_type" VALUES ('9', '5', '1');
INSERT INTO "public"."constraint_dataman_field_type" VALUES ('10', '5', '2');
INSERT INTO "public"."constraint_dataman_field_type" VALUES ('11', '6', '1');
INSERT INTO "public"."constraint_dataman_field_type" VALUES ('12', '6', '2');
INSERT INTO "public"."constraint_dataman_field_type" VALUES ('13', '7', '1');
INSERT INTO "public"."constraint_dataman_field_type" VALUES ('14', '7', '2');
INSERT INTO "public"."constraint_dataman_field_type" VALUES ('15', '8', '1');
INSERT INTO "public"."constraint_dataman_field_type" VALUES ('16', '8', '2');
...
-- ----------------------------
-- Table structure for dataman_field_type
-- ----------------------------
DROP TABLE IF EXISTS "public"."dataman_field_type";
CREATE TABLE "public"."dataman_field_type" (
"_id" int4 DEFAULT nextval('dataman_field_type__id_seq'::regclass) NOT NULL,
"name" varchar(255) COLLATE "default" NOT NULL
)
WITH (OIDS=FALSE)
...
-- ----------------------------
-- Records of dataman_field_type
-- ----------------------------
INSERT INTO "public"."dataman_field_type" VALUES ('1', 'int');
INSERT INTO "public"."dataman_field_type" VALUES ('2', 'string');

-- ----------------------------
-- Table structure for dataman_field_type_datasource_field_type
-- ----------------------------
DROP TABLE IF EXISTS "public"."dataman_field_type_datasource_field_type";
CREATE TABLE "public"."dataman_field_type_datasource_field_type" (
"_id" int4 DEFAULT nextval('dataman_field_type_datasource_field_type__id_seq'::regclass) NOT NULL,
"dataman_field_type_id" int4 NOT NULL,
"datasource_field_type_id" int4 NOT NULL
)
WITH (OIDS=FALSE)
...
-- ----------------------------
-- Records of dataman_field_type_datasource_field_type
-- ----------------------------
INSERT INTO "public"."dataman_field_type_datasource_field_type" VALUES ('1', '1', '1');
INSERT INTO "public"."dataman_field_type_datasource_field_type" VALUES ('2', '1', '2');
INSERT INTO "public"."dataman_field_type_datasource_field_type" VALUES ('3', '1', '3');
INSERT INTO "public"."dataman_field_type_datasource_field_type" VALUES ('4', '1', '4');
INSERT INTO "public"."dataman_field_type_datasource_field_type" VALUES ('6', '1', '6');
INSERT INTO "public"."dataman_field_type_datasource_field_type" VALUES ('7', '1', '7');
INSERT INTO "public"."dataman_field_type_datasource_field_type" VALUES ('8', '1', '8');
INSERT INTO "public"."dataman_field_type_datasource_field_type" VALUES ('9', '1', '9');
INSERT INTO "public"."dataman_field_type_datasource_field_type" VALUES ('10', '1', '10');
...
-- ----------------------------
-- Table structure for datasource_field_type
-- ----------------------------
DROP TABLE IF EXISTS "public"."datasource_field_type";
CREATE TABLE "public"."datasource_field_type" (
"_id" int4 DEFAULT nextval('datasource_field_type__id_seq'::regclass) NOT NULL,
"name" varchar(255) COLLATE "default" NOT NULL,
...
-- ----------------------------
-- Records of datasource_field_type
-- ----------------------------
INSERT INTO "public"."datasource_field_type" VALUES ('1', 'smallint', '1');
INSERT INTO "public"."datasource_field_type" VALUES ('2', 'integer', '1');
INSERT INTO "public"."datasource_field_type" VALUES ('3', 'bigint', '1');
INSERT INTO "public"."datasource_field_type" VALUES ('4', 'decimal', '1');
INSERT INTO "public"."datasource_field_type" VALUES ('6', 'decimal', '2');
INSERT INTO "public"."datasource_field_type" VALUES ('7', 'bigint', '2');
INSERT INTO "public"."datasource_field_type" VALUES ('8', 'int', '2');
INSERT INTO "public"."datasource_field_type" VALUES ('9', 'smallint', '2');
INSERT INTO "public"."datasource_field_type" VALUES ('10', 'tinyint', '2');
INSERT INTO "public"."datasource_field_type" VALUES ('11', 'character varying', '1');

-- ----------------------------
-- Table structure for datasource_field_type_arg
-- ----------------------------
DROP TABLE IF EXISTS "public"."datasource_field_type_arg";
CREATE TABLE "public"."datasource_field_type_arg" (
"_id" int4 DEFAULT nextval('datasource_field_type_arg__id_seq'::regclass) NOT NULL,
"name" varchar(255) COLLATE "default" NOT NULL,
"datasource_field_type_id" int4 NOT NULL,
"dataman_field_type_id" int4 NOT NULL
)
...
-- ----------------------------
-- Records of datasource_field_type_arg
-- ----------------------------
INSERT INTO "public"."datasource_field_type_arg" VALUES ('1', 'size', '11', '2');
...
-- ----------------------------
INSERT INTO "public"."field_type" VALUES ('1', 'age', '1');
INSERT INTO "public"."field_type" VALUES ('2', 'phone number', '2');
...
-- ----------------------------
INSERT INTO "public"."field_type_constraint" VALUES ('1', '1', '1');

-- ----------------------------
-- Table structure for field_type_constraint_arg
-- ----------------------------
DROP TABLE IF EXISTS "public"."field_type_constraint_arg";
CREATE TABLE "public"."field_type_constraint_arg" (
"_id" int4 DEFAULT nextval('field_type_constraint_arg__id_seq'::regclass) NOT NULL,
"field_type_constraint_id" int4 NOT NULL,
"constraint_arg_id" int4 NOT NULL,
...
-- ----------------------------
-- Records of field_type_constraint_arg
-- ----------------------------
INSERT INTO "public"."field_type_constraint_arg" VALUES ('1', '1', '1', '200');

-- ----------------------------
-- Table structure for field_type_datasource_field_type
-- ----------------------------
DROP TABLE IF EXISTS "public"."field_type_datasource_field_type";
CREATE TABLE "public"."field_type_datasource_field_type" (
"_id" int4 DEFAULT nextval('field_type_datasource_field_type__id_seq'::regclass) NOT NULL,
"field_type_id" int4 NOT NULL,
"datasource_field_type_id" int4 NOT NULL
)
WITH (OIDS=FALSE)
...
-- ----------------------------
-- Records of field_type_datasource_field_type
-- ----------------------------
INSERT INTO "public"."field_type_datasource_field_type" VALUES ('1', '1', '1');
INSERT INTO "public"."field_type_datasource_field_type" VALUES ('2', '1', '9');
INSERT INTO "public"."field_type_datasource_field_type" VALUES ('3', '2', '11');

-- ----------------------------
-- Table structure for field_type_datasource_field_type_arg
-- ----------------------------
DROP TABLE IF EXISTS "public"."field_type_datasource_field_type_arg";
CREATE TABLE "public"."field_type_datasource_field_type_arg" (
"_id" int4 DEFAULT nextval('field_type_datasource_field_type_arg__id_seq'::regclass) NOT NULL,
"field_type_datasource_field_type_id" int4,
"datasource_field_type_arg_id" int4 NOT NULL,
"value" varchar(255) COLLATE "default" NOT NULL
)
WITH (OIDS=FALSE)
...
-- ----------------------------
-- Records of field_type_datasource_field_type_arg
-- ----------------------------
INSERT INTO "public"."field_type_datasource_field_type_arg" VALUES ('1', '3', '1', '10');
...
-- ----------------------------
-- Primary Key structure for table datasource_field_type
-- ----------------------------
ALTER TABLE "public"."datasource_field_type" ADD PRIMARY KEY ("_id");

-- ----------------------------
-- Primary Key structure for table datasource_field_type_arg
-- ----------------------------
ALTER TABLE "public"."datasource_field_type_arg" ADD PRIMARY KEY ("_id");
...
-- ----------------------------
-- Primary Key structure for table field_type_constraint_arg
-- ----------------------------
ALTER TABLE "public"."field_type_constraint_arg" ADD PRIMARY KEY ("_id");

-- ----------------------------
-- Indexes structure for table field_type_datasource_field_type
-- ----------------------------
CREATE UNIQUE INDEX "field_type_datasource_field_type_field_type_id_idx" ON "public"."field_type_datasource_field_type" USING btree ("field_type_id", "datasource_field_type_id");

-- ----------------------------
-- Primary Key structure for table field_type_datasource_field_type
-- ----------------------------
ALTER TABLE "public"."field_type_datasource_field_type" ADD PRIMARY KEY ("_id");

-- ----------------------------
-- Primary Key structure for table field_type_datasource_field_type_arg
-- ----------------------------
ALTER TABLE "public"."field_type_datasource_field_type_arg" ADD PRIMARY KEY ("_id");
...
-- ----------------------------
-- Foreign Key structure for table "public"."datasource_field_type"
-- ----------------------------
ALTER TABLE "public"."datasource_field_type" ADD FOREIGN KEY ("datasource_id") REFERENCES "public"."datasource" ("_id") ON DELETE NO ACTION ON UPDATE NO ACTION;
